...
Tableau Workshop - I did a 4-hour personal dashboard challenge using a data set from this

[Kaggle challenge](https://www.kaggle.com/datasets/rhuebner/human-resources-data-set).

Prior to starting the challenge, I utilized SQL to clean and consolidate data sets before pluggig them into Tableau.
